...
capture cd "C:\Dropbox\Firm Survey\AER-final\replication_folder\output"
	...
	*** dummy: log ratio of std
	...
	reg ln_pi_ue X1_pi_ue [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X1_pi_ue  using "Table08_panelB.txt", replace dec(3) ctitle("ln_pi_ue") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
reg ln_pi_gdp X1_pi_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in ln_pi_gdp X1_pi_gdp {
	...
	capture drop wgt0
	gen wgt0=w4_wgtE_43*rreg_wgt
	reg ln_pi_gdp X1_pi_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X1_pi_gdp  using "Table08_panelB.txt", append dec(3) ctitle("ln_pi_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg ln_ue_gdp X1_ue_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in ln_ue_gdp X1_ue_gdp {
	...
	reg ln_ue_gdp X1_ue_gdp [aw=wgt0] , robust cluster(anzsic_code3)

outreg2 X1_ue_gdp  using "Table08_panelB.txt", append dec(3) ctitle("ln_ue_gdp") nocons


*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*** continuous: log ratio of std
reg ln_pi_ue X2_pi_ue, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in ln_pi_ue X2_pi_ue {
	...
	reg ln_pi_ue X2_pi_ue [aw=wgt0] , robust cluster(anzsic_code3)

outreg2 X2_pi_ue  using "Table08_panelB.txt", append dec(3) ctitle("ln_pi_ue") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg ln_pi_gdp X2_pi_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in ln_pi_gdp X2_pi_gdp {
	...
	reg ln_pi_gdp X2_pi_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_pi_gdp  using "Table08_panelB.txt", append dec(3) ctitle("ln_pi_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg ln_ue_gdp X2_ue_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in ln_ue_gdp X2_ue_gdp {
	...
	reg ln_ue_gdp X2_ue_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_ue_gdp  using "Table08_panelB.txt", append dec(3) ctitle("ln_ue_gdp") nocons


*============================================================================
*				Panel C: backcast errros
*============================================================================


reg BE_pi_ue X1_pi_ue, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in  BE_pi_ue X1_pi_ue {
	...
	reg  BE_pi_ue X1_pi_ue [aw=wgt0] , robust cluster(anzsic_code3)

outreg2 X1_pi_ue  using "Table08_panelC.txt", replace dec(3) ctitle("ln_pi_ue") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg BE_pi_gdp X1_pi_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in BE_pi_gdp X1_pi_gdp {
	...
	reg  BE_pi_gdp X1_pi_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X1_pi_gdp  using "Table08_panelC.txt", append dec(3) ctitle("BE_pi_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg BE_ue_gdp X1_ue_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in BE_ue_gdp X1_ue_gdp {
	...
	reg  BE_ue_gdp X1_ue_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X1_ue_gdp  using "Table08_panelC.txt", append dec(3) ctitle("BE_ue_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg BE_pi_ue X2_pi_ue, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in  BE_pi_ue X2_pi_ue {
	...
	reg  BE_pi_ue X2_pi_ue [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_pi_ue  using "Table08_panelC.txt", append dec(3) ctitle("ln_pi_ue") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg BE_pi_gdp X2_pi_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in BE_pi_gdp X2_pi_gdp {
	...
	reg BE_pi_gdp X2_pi_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_pi_gdp  using "Table08_panelC.txt", append dec(3) ctitle("BE_pi_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg BE_ue_gdp X2_ue_gdp, robust
	...
	foreach var in BE_ue_gdp X2_ue_gdp {
	...
	reg BE_ue_gdp X2_ue_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_ue_gdp  using "Table08_panelC.txt", append dec(3) ctitle("BE_ue_gdp") nocons
...
reg PAY_pi_ue X1_pi_ue, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in  PAY_pi_ue X1_pi_ue {
	...
	reg  PAY_pi_ue X1_pi_ue [aw=wgt0] , robust cluster(anzsic_code3)

outreg2 X1_pi_ue  using "Table08_panelA.txt", replace dec(3) ctitle("ln_pi_ue") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg PAY_pi_gdp X1_pi_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in PAY_pi_gdp X1_pi_gdp {
	...
	reg  PAY_pi_gdp X1_pi_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X1_pi_gdp  using "Table08_panelA.txt", append dec(3) ctitle("PAY_pi_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg PAY_ue_gdp X1_ue_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in PAY_ue_gdp X1_ue_gdp {
	...
	reg  PAY_ue_gdp X1_ue_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X1_ue_gdp  using "Table08_panelA.txt", append dec(3) ctitle("PAY_ue_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg PAY_pi_ue X2_pi_ue, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in  PAY_pi_ue X2_pi_ue {
	...
	reg  PAY_pi_ue X2_pi_ue [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_pi_ue  using "Table08_panelA.txt", append dec(3) ctitle("ln_pi_ue") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg PAY_pi_gdp X2_pi_gdp, robust

	capture drop rreg_*
	capture drop ones
	gen ones=sqrt(w4_wgtE_43)
 
	foreach var in PAY_pi_gdp X2_pi_gdp {
	...
	reg PAY_pi_gdp X2_pi_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_pi_gdp  using "Table08_panelA.txt", append dec(3) ctitle("PAY_pi_gdp") nocons

*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
reg PAY_ue_gdp X2_ue_gdp, robust
	...
	foreach var in PAY_ue_gdp X2_ue_gdp {
	...
	reg PAY_ue_gdp X2_ue_gdp [aw=wgt0] , robust cluster(anzsic_code3)
	
outreg2 X2_ue_gdp  using "Table08_panelA.txt", append dec(3) ctitle("PAY_ue_gdp") nocons
