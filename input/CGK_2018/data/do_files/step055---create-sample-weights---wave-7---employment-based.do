 ...
 * load data
 use wave7, clear
 merge 1:1 firmid using wave6, keepusing(w6_employment)
keep if _merge==3
drop _merge

gen anzsic_code=w7_anzsic_cod 
...
/*
foreach var in 31 41 51 32 42 52 33 43 53 {
	rename wgtE_w6`var' w7_wgtE_`var'
}	
*/
...
compress
notes: "created by step055 - wave 7 create sample weights.do"
save NZ_census_weights_employment_w7, replace
