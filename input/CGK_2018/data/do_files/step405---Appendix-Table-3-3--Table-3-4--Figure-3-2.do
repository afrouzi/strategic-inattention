...
*				Appendix Table 3.3
*=========================================================================
tabstat w6_epi_12m w6_epi_12m_implied   [aw=w6_wgtE_43], stat(N mean p50 sd)


*=========================================================================
*				Appendix Table 3.3
*=========================================================================
reg w6_epi_12m_implied w6_epi_12m   , robust
rreg w6_epi_12m_implied w6_epi_12m   , nolog
qreg w6_epi_12m_implied w6_epi_12m   , nolog

*=========================================================================
*				Appendix Figure 3.2
*=========================================================================
twoway (scatter w6_epi_12m w6_epi_12m_implied, msymbol(oh) jitter(3)) ///
		(lfit  w6_epi_12m w6_epi_12m_implied) ///
		, legend(off) ///
		ytitle("Point forecast") ///
		xtitle("Mean forecast implied from the probability distribution") ///
		ylabel(-2(2)10) xlabel(-2(2)12)
