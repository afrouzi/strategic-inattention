...
capture cd "C:\Dropbox\Firm Survey\Stata_cleaned\workfiles"
...
foreach sic_digit in   3  {
	foreach emp_group_size in   4   {	
		...
		gen wgt`emp_group_size'`sic_digit'=firm_count/N_sample
...
save NZ_census_weights, replace
