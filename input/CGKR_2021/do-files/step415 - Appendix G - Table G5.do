...
foreach var in dn dk dp dw {
	ivreg2  FE_`var'_3m (rev_epi_ho_12m_exper=surp_epi) ///
		if w8_exper_groupN==2 | w8_exper_groupN==1, ffirst robust
	local F1=e(widstat)
	if "`var'"=="dn" {
		outreg2 using TableG5_cont_treatment2.dta, ///
...
***					3-month change of inflation expectation 
*** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

foreach var in dn dk dp dw {
	ivreg2  FE_`var'_3m (rev_epi_ho_12m_exper=surp_epi_ho) ///
		if w8_exper_groupN==3 | w8_exper_groupN==1, ffirst robust
	local F1=e(widstat)
	if "`var'"=="dn" {
		outreg2 using TableG5_cont_treatment3.dta, ///
...
foreach var in dn dk dp dw {
	ivreg2  FE_`var'_3m (rev_epi_ho_12m_exper=surp_epi_av) ///
		if w8_exper_groupN==4 | w8_exper_groupN==1, ffirst robust
	local F1=e(widstat)
	if "`var'"=="dn" {
		outreg2 using TableG5_cont_treatment4.dta, ///
...
***					immediate change in expectations
***					(results are similar for 3-month change of inflation expectation) 
*** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

foreach var in dn dk dp dw {
	ivreg2  FE_`var'_3m (rev_epi_ho_12m_exper=surp_pi) ///
		if w8_exper_groupN==5 | w8_exper_groupN==1, ffirst robust
	local F1=e(widstat)
		if "`var'"=="dn" {
		outreg2 using TableG5_cont_treatment5.dta, ///
			dta replace dec(3) ctitle("`var'") addstat("1 stage F",`F1')
	}
	else {
	outreg2 using TableG5_cont_treatment5.dta, ///	
...
*** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*** 				Pooled treatment effect (control vs all groups)
***					immediate change in expectations
***					(results are similar for 3-month change of inflation expectation) 
*** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

foreach var in dn dk dp dw {
	ivreg2  FE_`var'_3m (rev_epi_ho_12m_exper=surp_all) ///
		, ffirst robust
	local F1=e(widstat)
		if "`var'"=="dn" {
		outreg2 using TableG5_cont_treatment5.dta, ///
