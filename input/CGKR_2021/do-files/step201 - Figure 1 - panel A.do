...
quiet foreach ww in w8 { /* loop over waves */
		foreach i in  25plus  15_25 10_15  8_10 6_8  4_6  2_4  0_2 /// /* loop over survey questions */
				 ...
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'<=0 & `ww'_epi_12m_`i'~=. , d
				 local p0=r(N)
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>0 & `ww'_epi_12m_`i'<=10 & `ww'_epi_12m_`i'~=. , d
				 local p10=r(N)
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>10 & `ww'_epi_12m_`i'<=20 & `ww'_epi_12m_`i'~=. , d
				 local p20=r(N)
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>20 & `ww'_epi_12m_`i'<=30 & `ww'_epi_12m_`i'~=. , d
				 local p30=r(N)
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>30 & `ww'_epi_12m_`i'<=40 & `ww'_epi_12m_`i'~=. , d
				 local p40=r(N)

				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>40 & `ww'_epi_12m_`i'<=50 & `ww'_epi_12m_`i'~=. , d
				 local p50=r(N)
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>50 & `ww'_epi_12m_`i'<=60 & `ww'_epi_12m_`i'~=. , d
				 local p60=r(N)				 
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>60 & `ww'_epi_12m_`i'<=70 & `ww'_epi_12m_`i'~=. , d
				 local p70=r(N)	
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>70 & `ww'_epi_12m_`i'<=80 & `ww'_epi_12m_`i'~=. , d
				 local p80=r(N)	
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>80 & `ww'_epi_12m_`i'<=90 & `ww'_epi_12m_`i'~=. , d
				 local p90=r(N)		
				 
				 sum `ww'_epi_12m_`i' if `ww'_epi_12m_`i'>90 & `ww'_epi_12m_`i'<=100 & `ww'_epi_12m_`i'~=. , d
				 local p100=r(N)					 
				 
				 sum `ww'_epi_12m_`i' , d
				local mm=r(mean)
